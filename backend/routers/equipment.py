...
@router.post(
    "/athlete/{athlete_id}/equipment", response_model=schemas.Equipment, status_code=201
)
def create_equipment_endpoint(
    athlete_id: int, equipment: schemas.EquipmentCreate, db: Session = Depends(get_db)
):
